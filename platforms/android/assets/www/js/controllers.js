...
.controller('FactCtrl',function($scope){
   $scope.groups = [{
     title: "BAU",
     description: "Business as usual (BAU) is the normal execution of standard functional operations within an organization. It forms a possible contrast to projects or programmes which might introduce change.",
     contents: [{
       line: "x"
     }]
   },{
